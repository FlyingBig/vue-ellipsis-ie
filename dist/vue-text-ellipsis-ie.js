(function (global, factory) {
  ...
  var script = {
    ...
    methods: {
      setFontSizeNormal: function setFontSizeNormal() {
      ...
      getStylesOfText: function getStylesOfText() {
        ...
        this.$nextTick(function () {
          setTimeout(function () {
            ...
            for (var k in this$1$1.txtStyle) {
              span.style[k] = this$1$1.txtStyle[k];
            }
    ...
    return _c("div", { ref: "container", staticClass: "muti-ellipsis" }, [
      !_vm.clientIsIe
        ? _c(
            ...
            [_c("div", { style: _vm.txtStyle }, [_vm._v(_vm._s(_vm.text))])]
          )
